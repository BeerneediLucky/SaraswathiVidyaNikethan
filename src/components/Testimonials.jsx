          ...
          <div className="carousel-inner">
            <div className="carousel-item active">
              <div className="testimonial-card card border-0 shadow-sm p-4 reveal fade-right delay-1">
                <div className="testimonial-meta d-flex align-items-center gap-3 mb-3">
                  <img src="https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&w=100&q=80" alt="Parent 1" className="rounded-circle" loading="lazy" decoding="async" />
                  <div>
            ...
            <div className="carousel-item">
              <div className="testimonial-card card border-0 shadow-sm p-4 reveal fade-left delay-2">
                <div className="testimonial-meta d-flex align-items-center gap-3 mb-3">
                  <img src="https://images.unsplash.com/photo-1524504388940-b1c1722653e1?auto=format&fit=crop&w=100&q=80" alt="Parent 2" className="rounded-circle" loading="lazy" decoding="async" />
                  <div>
            ...
            <div className="carousel-item">
              <div className="testimonial-card card border-0 shadow-sm p-4 reveal fade-right delay-3">
                <div className="testimonial-meta d-flex align-items-center gap-3 mb-3">
                  <img src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=100&q=80" alt="Parent 3" className="rounded-circle" loading="lazy" decoding="async" />
                  <div>
